...
const ExploracionFisica = () => {
    ...
    const Get = () => {
        axios.get(`/api/explo_general_afeccion`)
            .then(response => {
...
const notificarErrorCaso = () =>
    ...
    const Post = () => {
        axios.post('/api/explo_general_afeccion', form)
            .then(response => {
    ...
    const Edit = () => {
        axios.put(`/api/explo_general_afeccion/${line.id}`, form)
            .then(response => {
    ...
    const Elimina = () => {
        axios.delete(`/api/explo_general_afeccion/${line.id}/delete`)
            .then(response => {
                Get()
                setLine('')
                return response.data;
    ...
    const columns = [{
        dataField: 'id',
        text: `${t("administracion.explorefisica.datos.id")}`,
        sort: true
    }, {
        dataField: 'explo_general_cat',
        text: `${t("administracion.explorefisica.datos.explo")}`,
        sort: true
    }, {
        dataField: 'descripcion',
        text: `${t("administracion.explorefisica.datos.descripcion")}`,
        sort: true
    }, {
        text:'',
        dataField: '786',
            ...
            return (
                <div>
                    <Icofont icon="search-1" className="mx-2" onClick={() => {
                        handleView()
                        setForm({
                            explo_general_cat: row.explo_general_cat,
    ...
    return (
        <div>
            <div>
                <h2>{t("administracion.explorefisica.titulo")}</h2>
            </div>
            <div>
                ...
                <Modal show={show} onHide={() => {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title> <h1>{t("administracion.explorefisica.titulo")} - {view ?  t("etiquetas.ver") : 'Borrar'}</h1></Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        ...
                        <Form>
                            <Form.Group as={Row} className="mb-3" controlId="formid">
                                ...
                                {t("administracion.explorefisica.datos.id")}
                                </Form.Label>
                                <Col sm="10">
                            ...
                            <Form.Group as={Row} className="mb-3" controlId="formname">
                                <Form.Label column sm="2">
                                {t("administracion.explorefisica.datos.explo")}
                                </Form.Label>
                                <Col sm="10">
                                    <Form.Control plaintext readOnly defaultValue={line.explo_general_cat} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formname">
                                <Form.Label column sm="2">
                                {t("administracion.explorefisica.datos.descripcion")}
                                </Form.Label>
                                <Col sm="10">
                ...
                <Modal show={showe} onHide={() => {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title>{t("administracion.explorefisica.titulo")} - {editar ? t("etiquetas.editar") :  t("etiquetas.agregar")}</Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        ...
                        <Form className='m-xxl-4'>
                            <Form.Group as={Row} className="mb-3" controlId="formcodigo">
                                ...
                                <Col sm={4} >
                                    <Form.Control type='text' placeholder={t("administracion.explorefisica.datos.explo")} value={form.explo_general_cat} onChange={handleChange} name="explo_general_cat" />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formcodigo">
                                <Form.Label column sm="3">
                                ...
                                <Col sm={4} >
                                    <Form.Control type='text' placeholder={t("administracion.explorefisica.datos.descripcion")} value={form.descripcion} onChange={handleChange} name="descripcion" />
                                </Col>
                            </Form.Group>
