...
const Procedimientos = () => {
    ...
    const Get = () => {
        axios.get(`/api/procedimiento_tipo`)
            .then(response => {
...
const notificarErrorCaso = () =>
    ...
    const Post = () => {
        axios.post('/api/procedimiento_tipo', form)
            .then(response => {
    ...
    const Edit = () => {
        axios.put(`/api/procedimiento_tipo/${line.id}`, form)
            .then(response => {
    ...
    const Elimina = () => {
        axios.delete(`/api/procedimiento_tipo/${line.id}/delete`)
            .then(response => {
                Get()
                setLine('')
                return response.data;
    ...
    const columns = [{
        dataField: 'id',
        text: `${t("administracion.procedimientos.datos.id")}`,
        sort: true
    }, {
        dataField: 'nombre_procedimiento',
        text: `${t("administracion.procedimientos.datos.nombre")}`,
        sort: true
    }, {
        text:'',
        dataField: '789',
    ...
    return (
        <div>
            <div>
                <h2>{t("administracion.procedimientos.titulo")}</h2>
            </div>
            <div>
                ...
                <Modal show={show} onHide={() => {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title> <h1>{t("administracion.procedimientos.titulo")} - {view ?  t("etiquetas.ver") : t("etiquetas.eliminar")}</h1></Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        ...
                        <Form>
                            <Form.Group as={Row} className="mb-3" controlId="formid">
                                ...
                                {t("administracion.procedimientos.datos.id")}
                                </Form.Label>
                                <Col sm="10">
                            ...
                            <Form.Group as={Row} className="mb-3" controlId="formname">
                                <Form.Label column sm="2">
                                {t("administracion.procedimientos.datos.nombre")}
                                </Form.Label>
                                <Col sm="10">
                                    <Form.Control plaintext readOnly defaultValue={line.nombre_procedimiento} />
                                </Col>
                            </Form.Group>
                        </Form>
                    </Modal.Body>
                ...
                <Modal show={showe} onHide={() => {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title>{t("administracion.procedimientos.titulo")} - {editar ? t("etiquetas.editar") :  t("etiquetas.agregar")}</Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        ...
                        <Form className='m-xxl-4'>
                            <Form.Group as={Row} className="mb-3" controlId="formcodigo">
                                ...
                                <Col sm={4} >
                                    <Form.Control type='text' placeholder={`${t("administracion.procedimientos.datos.nombre")}`} value={form.nombre_procedimiento} onChange={handleChange} name="nombre_procedimiento" />
                                </Col>
                            </Form.Group>
