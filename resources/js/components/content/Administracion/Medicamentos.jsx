...
const notificarErrorCaso = () =>
    ...
    const Post = () => {
        axios.post('/api/medicamentos', form)
            .then(response => {
                notificarExitoCaso(response.data.id_medicamento);
                Get()
                return response.data;
            })
            .catch(error => {
    ...
    const Edit = () => {
        axios.put(`/api/medicamentos/${line.id_medicamento}`, form)
            .then(response => {
    ...
    const Elimina = () => {
        axios.delete(`/api/medicamentos/${line.id_medicamento}/delete`)
            .then(response => {
                Get()
                setLine('')
                return response.data;
    ...
    const columns = [{
        ...
        text: `${t("administracion.medicamentos.datos.id")}`,
        sort: true
    }, {
        dataField: 'nombre_medicamento',
        text: `${t("administracion.medicamentos.datos.nombre")}`,
        sort: true
    }, {
        dataField: 'valor',
        text: `${t("administracion.medicamentos.datos.valor")}`,
        sort: true
    }, {
        text:'',
        dataField: '265',
    ...
    return (
        <div>
            <div>
                <h2>{t("administracion.medicamentos.titulo")}</h2>
            </div>
            <div>
                ...
                <Modal show={show} onHide={() => {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title> <h1>{t("administracion.medicamentos.titulo")} - {view ?  t("etiquetas.ver") : t("etiquetas.eliminar")}</h1></Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        ...
                        <Form>
                            <Form.Group as={Row} className="mb-3" controlId="formid">
                                ...
                                {t("administracion.medicamentos.datos.id")}
                                </Form.Label>
                                <Col sm="10">
                                    <Form.Control plaintext readOnly defaultValue={line.id_medicamento} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formname">
                                <Form.Label column sm="2">
                                {t("administracion.medicamentos.datos.nombre")}
                                </Form.Label>
                                <Col sm="10">
                                    <Form.Control plaintext readOnly defaultValue={line.nombre_medicamento} />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formname">
                                <Form.Label column sm="2">
                                {t("administracion.medicamentos.datos.valor")}
                                </Form.Label>
                                <Col sm="10">
                ...
                <Modal show={showe} onHide={() => {
                    ...
                    <Modal.Header closeButton>
                        <Modal.Title>{t("administracion.medicamentos.titulo")} - {editar ? t("etiquetas.editar") :  t("etiquetas.agregar")}</Modal.Title>
                    </Modal.Header>
                    ...
                    <Modal.Body>
                        ...
                        <Form className='m-xxl-4'>
                            <Form.Group as={Row} className="mb-3" controlId="formcodigo">
                                ...
                                <Col sm={4} >
                                    <Form.Control type='text' placeholder={`${t("administracion.medicamentos.datos.nombre")}`} value={form.nombre_medicamento} onChange={handleChange} name="nombre_medicamento" />
                                </Col>
                            </Form.Group>
                            <Form.Group as={Row} className="mb-3" controlId="formcodigo">
                                <Form.Label column sm="3">
                                ...
                                <Col sm={4} >
                                    <Form.Control type='text' placeholder={`${t("administracion.medicamentos.datos.valor")}`} value={form.valor} onChange={handleChange} name="valor" />
                                </Col>
                            </Form.Group>
