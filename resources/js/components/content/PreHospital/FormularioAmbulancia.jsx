...
const FormularioAmbulancia = (params) => {
    ...
    useEffect(() => {
        if (formAmbulancia.id_servcioambulacia) {
            ...
            const actualizar_servicio_ambulancia = async () => {
                await axios
                    .put(
                        `/api/preh_servicio_ambulancia/${formAmbulancia.id_servcioambulacia}`,
                        {
                            cod_casopreh: params.formAmbulancia.cod_casopreh,
                ...
                actualizar_servicio_ambulancia();
            };
        } else if (
            formAmbulancia.cod_casopreh != '' &&
            formAmbulancia.cod_casopreh != null
        ) {
            axios
                .post('/api/preh_servicio_ambulancia', {
                    cod_casopreh: params.formAmbulancia.cod_casopreh,
                ...
                <Modal.Footer>
                    <Button
                        ...
                        onClick={() => {
                            ...
                            setFormAmbulancia((prevState) => ({
                                ...prevState,
                                cod_ambulancia: idambulanciaTemp,
                            }));
                            // actual();
                            handleClose2();
                        }}
