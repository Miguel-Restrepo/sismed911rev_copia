...
const FormularioPaciente = (params) => {
    ...
    const handleChangeFormPacienteNuevoCedula = (e) => {
        ...
        setFormPaciente((prevState) => ({
            ...prevState,
            [e.target.name]: e.target.value,
            cod_casointerh: params.formPaciente.cod_casointerh,
        }));
    };
    ...
    return (
        <div>
            <Form>
                ...
                {params.formPaciente.cod_casointerh != "" &&
            ...
            <Modal show={show2} onHide={handleClose2} size="xl">
                <Modal.Header closeButton>
                    <Modal.Title>
                        {t("formularios.formpacientes.crearpaciente")}
                    </Modal.Title>
                </Modal.Header>
