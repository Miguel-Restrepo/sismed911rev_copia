...
const notificarErrorCaso = () =>
    ...
    const PostAsistenciaPrestada = async (fechaInicio, fechaFin,SRS) => {
        ...
        await axios.post('api/estadisticas/interh/asistencia_prestada', null, {
            params: {
    ...
    const PostSegunCondicion = async (fechaInicio, fechaFin,SRS) => {
        ...
        await axios.post('api/estadisticas/interh/segun_condicion', null, {
            params: {
                fecha_inicio: fechaInicio,
                fecha_fin: fechaFin,
                SRS:SRS
    ...
    const PostMotivoTraslado = async (fechaInicio, fechaFin,SRS) => {
        ...
        await axios.post('api/estadisticas/interh/motivo_traslado', null, {
            params: {
                fecha_inicio: fechaInicio,
                fecha_fin: fechaFin,
                SRS:SRS
    ...
    const PostNacionalidad = async (fechaInicio, fechaFin,SRS) => {
        ...
        await axios.post('api/estadisticas/interh/nacionalidad', null, {
            params: {
                fecha_inicio: fechaInicio,
                fecha_fin: fechaFin,
                SRS:SRS
    ...
    const PostTipoPx = async (fechaInicio, fechaFin,SRS) => {
        ...
        await axios.post('api/estadisticas/interh/tipo_px', null, {
            params: {
                fecha_inicio: fechaInicio,
                fecha_fin: fechaFin,
                SRS:SRS
    ...
    const PostTotales = async (fechaInicio, fechaFin,SRS) => {
        ...
        await axios.post('api/estadisticas/interh/totales', null, {
            params: {
                fecha_inicio: fechaInicio,
                fecha_fin: fechaFin,
                SRS:SRS
    ...
    return (
        <Container fluid>
            <Row className='pb-4'>
                ...
                <Col xs={7}>
                    <Card className='h-100'>
                        <Card.Body>
                            <h2 className='d-flex justify-content-center py-4' style={{ color: '#073c53' }}>{t("interhospital.trasladointerh.trasladosinter")}</h2>
                        </Card.Body>
                    </Card>
                </Col>
            ...
            <Row className='pb-4'>
                ...
                <Col xs={5}>
                    <Card className="h-100">
                        <Card.Header>Traslados según Condición</Card.Header>
                                ...
                                <div>
                                    <Card className='mb-1'>
                                        ...
                                        <Card.Body className='d-flex justify-content-center' style={{ alignItems: 'center' }}>
                                            <h5 className='text-center'>{dataTotales[0].total_asistencia}</h5>
                                        </Card.Body>
                                    </Card>
                                    <Card className='mb-1'>
                                        ...
                                        <Card.Body className='d-flex justify-content-center' style={{ alignItems: 'center' }}>
                                            <h5 className='text-center'>{dataTotales[0].completados}</h5>
                                        </Card.Body>
                                    </Card>
                                    <Card className='mb-1'>
                                        <Card.Header as="h6" style={{ color: '#FFFFFF', backgroundColor: '#073c53' }}>{t("interhospital.trasladointerh.fallecidos")}</Card.Header>
                                        <Card.Body className='d-flex justify-content-center' style={{ alignItems: 'center' }}>
                                            <h5 className='text-center'>{dataTotales[0].fallecidos}</h5>
                                        </Card.Body>
                                    </Card>
                                    <Card className='mb-1'>
                                        <Card.Header as="h6" style={{ color: '#FFFFFF', backgroundColor: '#073c53' }}>{t("interhospital.trasladointerh.trasladospcte")}</Card.Header>
                                        <Card.Body className='d-flex justify-content-center' style={{ alignItems: 'center' }}>
                                            <h5 className='text-center'>{dataTotales[0].traslado_paciente}</h5>
                                        </Card.Body>
                                    </Card>
                                </div>
                            }
