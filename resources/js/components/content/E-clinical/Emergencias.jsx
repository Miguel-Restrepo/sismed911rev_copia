...
function Emergencias() {
    ...
    const columns1 = [
        ...
        {
            text: `${t("eclinical.emergencias.datos.tiempo")}`,
            dataField: "789",
            formatter: (cell, row, rowIndex, extraData) => {
                return (
                    <div>
        ...
        <div>
            ...
            {mostrarFormulario && (
                <Tabs
                    ...
                    className="mb-3"
                >
                    <Tab eventKey="home" title="Atención Medica">
                        {mostrarFormulario && (
                            <Form
                                className={
                                    mostrarFormulario ? "show-element" : null
                                }
                            >
                                <Row className="mb-4">
                                    <Form.Group as={Col}>
                                ...
                                <Row className="mb-2">
                                    ...
                                    <Form.Group as={Col}>
                                        ...
                                        <Form.Control
                                            ...
                                            placeholder="Descripción diagnostivo"
                    ...
                    <Tab eventKey="profile" title="Monitoreo Kamba">
                        <FormularioKamban
                            monitoreo={monitoreo}
